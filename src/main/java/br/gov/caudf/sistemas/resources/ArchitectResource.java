...
public class ArchitectResource {
	
	@Autowired
	private ArchitectService service;
	
	@GetMapping
	public ResponseEntity<Page<ArchitectDTO>> findAll(
		...
		Page<ArchitectDTO> list = service.findAllPaged(pageRequest);
		
		return ResponseEntity.ok().body(list);
	}
	
	@GetMapping(value = "/{id}")
	public ResponseEntity<ArchitectDTO> findById(@PathVariable Long id){
		ArchitectDTO dto = service.findById(id);
