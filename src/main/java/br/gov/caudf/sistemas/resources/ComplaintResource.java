...
import br.gov.caudf.sistemas.services.ComplaintService;
...
public class ComplaintResource {
	...
	@GetMapping
	public ResponseEntity<Page<ComplaintDTO>> findAll(@RequestParam(value = "page", defaultValue = "0") Integer page,
		...
		Page<ComplaintDTO> list = service.findAllPaged(pageRequest);
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<ComplaintDTO> update(@PathVariable Long id, @RequestBody ComplaintDTO dto) {
